// i281_CPU.v - Cleaned up for Icarus Verilog compatibility
...
// Logic Blocks and Component Instantiations

// Clock Logic DFF (DFF_inst13) - FIXED always block syntax
always @(posedge SYNTHESIZED_WIRE_69 or negedge SYNTHESIZED_WIRE_9 or negedge SYNTHESIZED_WIRE_12)
begin
    if (SYNTHESIZED_WIRE_9 == 1'b0) begin // Check for synchronous reset/clear
        DFF_inst13 <= 1'b0;
    end
    else if (SYNTHESIZED_WIRE_12 == 1'b0) begin // Check for synchronous set
        DFF_inst13 <= 1'b1;
    end
    else begin
...
// Reset Logic DFF (Reset) - FIXED always block syntax
always @(posedge SYNTHESIZED_WIRE_69 or negedge SYNTHESIZED_WIRE_16 or negedge SYNTHESIZED_WIRE_19)
begin
    if (SYNTHESIZED_WIRE_16 == 1'b0) begin // Check for synchronous clear
        Reset <= 1'b0;
    end
    else if (SYNTHESIZED_WIRE_19 == 1'b0) begin // Check for synchronous set
        Reset <= 1'b1;
    end
    else begin
...
Opcode_Decoder	b2v_inst1(
	...
	.BRE_BRZ(SYNTHESIZED_WIRE_42), // FIXED: Renamed port
	.BRNE_BRNZ(SYNTHESIZED_WIRE_43), // FIXED: Renamed port
...
Control_FSM	b2v_inst23(
	...
	.BRGE(SYNTHESIZED_WIRE_46),
	.LOADI_LOADP(SYNTHESIZED_WIRE_47), // FIXED: Renamed port
	.X(SYNTHESIZED_WIRE_48),
	.Y(SYNTHESIZED_WIRE_49),
