// Control_FSM.v - Cleaned up for Icarus Verilog compatibility
// Original generated by Quartus Prime Version 18.1.0 Build 625 09/12/2018
...
module Control_FSM(
	...
	NEGATIVE_FLAG,
	BRGE,
	LOADI_LOADP, // Corrected from LOADI/LOADP
	X,
	Y,
	IMEM_WRITE_ENABLE,
	ALU_SOURCE_MUX,
...
// Input Declarations (Corrected illegal names here)
input wire	NOOP;
...
input wire	JUMP;
input wire	BRE_BRZ;      // Corrected from BRE/BRZ
input wire	BRNE_BRNZ;    // Corrected from BRNE/BRNZ
input wire	BRG;
input wire	CARRY_FLAG;
input wire	OVERFLOW_FLAG;
input wire	NEGATIVE_FLAG;
input wire	BRGE;
input wire	LOADI_LOADP;  // Corrected from LOADI/LOADP
input wire	[1:0] X;
input wire	[1:0] Y;
...
// Internal Wires (Kept original names for synthesized logic)
...
// CORRECTED: BRE_BRZ
assign	SYNTHESIZED_WIRE_36 = BRE_BRZ & ZERO_FLAG;

// CORRECTED: BRNE_BRNZ
assign	SYNTHESIZED_WIRE_39 = SYNTHESIZED_WIRE_43 & BRNE_BRNZ;
...
// Note: Icarus supports ~^ (XNOR), so this should be fine.
...
// NOTE: 'Block3' is likely a generic Quartus-generated module for a 2:1 MUX (1-bit wide).
// If this block is defined elsewhere (e.g., in i281_cpu.v or another .v file), 
// Icarus will find it during compilation.
Block3	b2v_inst43(
	.i0(X[1]),
	.i1(Y[1]),
...
// CORRECTED: LOADI_LOADP
assign	SYNTHESIZED_WIRE_14 = MOVE | ADD | ADDI | LOADI_LOADP; 
...
// CORRECTED: LOADI_LOADP
assign	SYNTHESIZED_WIRE_35 = INPUT_DATAD | LOADI_LOADP | INPUT_DATAC; 
